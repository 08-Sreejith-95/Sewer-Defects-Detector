...
# Then use the top predicted class for GradCAM
    model.eval()
    sample_image = "/kaggle/working/Sewer-Defects-Detector/sewage_defect_detector/visualization/defect_class_multiple.png"  # To do:add configuration option for this path
